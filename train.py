...
from nets._training import (Loss, ModelEMA, get_lr_scheduler,
...
if __name__ == "__main__":
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = cfg['train_cfg']['cuda_visible_devices']
    
    Cuda            = cfg['train_cfg']['cuda']
    seed            = cfg['train_cfg']['seed']
    distributed     = cfg['train_cfg']['distributed']
    sync_bn         = cfg['train_cfg']['sync_bn']
    ...
    pretrained      = cfg['train_cfg']['pretrained']
    ...
    Freeze_Epoch        = cfg['train_cfg']['freeze_epoch']
    Freeze_batch_size   = cfg['train_cfg']['freeze_batch_size']
